...
bool TestEffect3::init()
{
  ...
  RETURN_ON_FAIL_BOOL(
    s.add_file_changed(s.convert_path("sculptris/sphere.obj", System::kDirDropBox), MakeDelegate(this, &TestEffect3::load_mesh), true),
...
bool TestEffect3::render()
{
  ...
  D3DXMatrixLookAtLH(&view, &D3DXVECTOR3(0,0, -150), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,1,0));
